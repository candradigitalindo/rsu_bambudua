        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Form Ubah Insentif Manual</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('keuangan.insentif.update', $incentive->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <select class="form-select select2 @error('user_id') is-invalid @enderror" id="user_id"
                                ...
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                        {{ old('user_id', $incentive->user_id) == $employee->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror"
                                ...
                                value="{{ old('description', $incentive->description) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('amount') is-invalid @enderror"
                                id="amount_display"
                                value="{{ old('amount', number_format($incentive->amount, 0, ',', '.')) }}"
