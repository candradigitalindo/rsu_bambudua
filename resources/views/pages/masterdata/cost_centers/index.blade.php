  ...
  <div class="col-12">
    <div class="card mb-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Cost Center</h5>
      </div>
      <div class="card-body">
        @if (session('success'))
        ...
        @endif
        <div class="mb-3">
          <a href="{{ route('master.cost-centers.create') }}" class="btn btn-primary">Tambah Cost Center</a>
        </div>
        <div class="table-responsive">
          <table class="table m-0" id="ccTable">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function(){
      if (window.jQuery && jQuery.fn.DataTable) {
        jQuery('#ccTable').DataTable({ paging: false, searching: true });
      }
    });
  </script>
@endpush
