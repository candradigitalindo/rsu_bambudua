        ...
        <div class="col-xxl-8 col-lg-10 mx-auto">
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="card-title">Edit Pengaturan Reminder</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('reminder-settings.update', $reminderSetting->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $reminderSetting->name) }}"
                                placeholder="Contoh: Reminder Beli Obat Lagi" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"
                                ...
                                <option value="obat"
                                    {{ old('type', $reminderSetting->type) == 'obat' ? 'selected' : '' }}>Beli Obat</option>
                                <option value="checkup"
                                    {{ old('type', $reminderSetting->type) == 'checkup' ? 'selected' : '' }}>Check Up /
                                    Kontrol</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('days_before') is-invalid @enderror"
                                id="days_before" name="days_before"
                                value="{{ old('days_before', $reminderSetting->days_before) }}" min="1"
                                max="365" required>
                            @error('days_before')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('message_template') is-invalid @enderror" id="message_template"
                                ...
                                placeholder="Contoh:&#10;*Bambu Dua Clinic* – *Pengingat*&#10;&#10;Halo {nama_pasien},&#10;Reminder untuk kontrol kesehatan...">{{ old('message_template', $reminderSetting->message_template) }}</textarea>
                            ...
                            <small class="form-text text-muted">
                                ...
                                • <code>{tanggal}</code> - Tanggal reminder akan dikirim<br>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                    value="1" {{ old('is_active', $reminderSetting->is_active) ? 'checked' : '' }}>
