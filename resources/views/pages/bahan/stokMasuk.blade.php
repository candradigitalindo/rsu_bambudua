...
@section('content')
    <div class="row gx-3">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bahan.stokBahan', $bahan->id) }}" method="POST" id="submit">
                        @csrf
                        <!-- Custom tabs starts -->
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                    ...
                                    <div class="row gx-3 mt-3">
                                        <div class="{{ $bahan->is_expired == 1 ? 'col-xxl-6 ' : 'col-xxl-12 ' }} col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                        ...
                                        @if ($bahan->is_expired == 1)
                                            ...
                                            <div class="col-xxl-6 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="expired_at">Tanggal Expired<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
