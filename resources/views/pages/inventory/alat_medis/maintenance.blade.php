@extends('layouts.app')
@section('title','Perawatan & Kalibrasi')
@push('style')
...
<div class="row gx-3">
  <div class="col-12">
    <div class="card mb-3">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('inventory.equipment.maintenance.store', $equipment['id']) }}" class="row g-2 mb-3 align-items-end">
          @csrf
          <div class="col-md-2">
          ...
          <div class="col-md-12">
            <div class="form-check">
              ...
              <label class="form-check-label" for="post_to_finance">
                Catat sebagai Pengeluaran Operasional Keuangan (otomatis masuk Laba-Rugi & Kas/Bank)
              </label>
            </div>
          </div>
          <div class="col-md-4">
