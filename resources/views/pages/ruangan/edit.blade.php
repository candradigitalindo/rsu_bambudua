@extends('layouts.app')
@section('title', 'Buat Ruangan Edit')
@push('style')
    <!-- Scrollbar CSS -->
...
@section('content')
    <div class="row gx-3">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('ruangan.update', $ruangan->id) }}" method="POST" id="submit">
                        @csrf
                        @method('PUT')
                        <!-- Custom tabs starts -->
                                                    ...
                                                    <select class="form-select" id="a7" name="category">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ $ruangan->category_id == $category->id ? 'selected' : '' }}>
                                                                {{ $category->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="a1"
                                                        name="no_kamar" value="{{ $ruangan->no_kamar }}">
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="harga" name="harga"
                                                        value="{{ $ruangan->getHargaFormattedAttribute() }}">
                                                </div>
                                        ...
                                        <div class="col-xxl-12 col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea name="description" class="form-control" id="description" cols="10" rows="5">{{ $ruangan->description }}</textarea>
                                                </div>
