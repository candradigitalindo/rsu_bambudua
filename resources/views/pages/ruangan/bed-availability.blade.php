...
@push('style')
    ...
    <style>
        ...
        .availability-high { border-left: 4px solid #28a745; }
        .availability-medium { border-left: 4px solid #ffc107; }
        .availability-low { border-left: 4px solid #dc3545; }
        .availability-full { border-left: 4px solid #6c757d; }
        
        .bed-icon { font-size: 2rem; }
        .occupancy-progress { height: 8px; }
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <small class="text-muted">
                                        {{ $classData['total_rooms'] }} ruangan • {{ $classData['total_beds'] }} bed
                                    </small>
                                </div>
                                <div class="text-end">
                                    <span class="badge bg-{{ $classData['available_beds'] > 5 ? 'success' : ($classData['available_beds'] > 2 ? 'warning' : 'danger') }} fs-6">
                                    ...
                                    <div class="room-detail-card p-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <br>
                                                <small class="text-muted">{{ $room['capacity'] }} bed</small>
                                            </div>
                                            <div class="text-end">
                                                <span class="badge bg-{{ $room['available'] > 0 ? 'success' : 'secondary' }}">
                                        ...
                                        @if($room['description'])
                                        <small class="text-muted d-block mt-1">{{ $room['description'] }}</small>
                                        @endif
                                    </div>
                                </div>
                                @endforeach
