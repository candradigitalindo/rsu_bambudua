        ...
        <div class="col-12 col-lg-10">
            ...
            <div class="d-flex justify-content-between align-items-center report-header">
                <div>
                    ...
                    <div class="small-text">Tanggal:
                        {{ $req->completed_at?->format('d M Y H:i') ?? $req->created_at->format('d M Y H:i') }}</div>
                </div>
                <div class="no-print">
                    <button class="btn btn-sm btn-primary" onclick="window.print()"><i class="ri-printer-line"></i>
                        Cetak</button>
                </div>
            </div>
            <div class="mb-3">
