                    ...
                    <form action="{{ route('payment-methods.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name') }}" placeholder="Contoh: Transfer Bank, E-Wallet, Kartu Kredit"
                                required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" name="code"
                                value="{{ old('code') }}" placeholder="Contoh: BANK_TRANSFER, EWALLET" required>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('fee_type') is-invalid @enderror" name="fee_type"
                                        ...
                                        <option value="percentage" {{ old('fee_type') == 'percentage' ? 'selected' : '' }}>
                                            Persentase (%)</option>
                                        <option value="fixed" {{ old('fee_type') == 'fixed' ? 'selected' : '' }}>Tetap
                                            (Nominal)</option>
                                        <option value="both" {{ old('fee_type') == 'both' ? 'selected' : '' }}>Kombinasi
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3" id="fee_percentage_group">
                                        ...
                                        <input type="number" step="0.01" min="0" max="100"
                                            ...
                                            name="fee_percentage" value="{{ old('fee_percentage', 0) }}"
                                            placeholder="0.00">
                                    ...
                                    <div class="col-md-6 mb-3" id="fee_fixed_group">
                                        ...
                                        <input type="number" step="0.01" min="0"
                                            ...
                                            value="{{ old('fee_fixed', 0) }}" placeholder="0">
