...
@section('title', 'Tambah Bahan Radiologi')
            ...
            <div class="col-md-8">
                ...
                <div class="page-header-card mb-4">
                    <h4 class="mb-1 fw-bold">
                        ...
                        Tambah Bahan Radiologi
                    </h4>
                    <p class="text-muted mb-0">Tambahkan bahan atau supplies radiologi baru</p>
                </div>

                <!-- Form Card -->
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        <form action="{{ route('radiologi.supplies.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    ...
                                    placeholder="Contoh: Film X-Ray, Kontras, dll" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                    ...
                                    placeholder="Contoh: lembar, botol, box, dll">
                                @error('unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('warning_stock') is-invalid @enderror"
                                    id="warning_stock" name="warning_stock" value="{{ old('warning_stock', 10) }}"
                                    min="0" required>
