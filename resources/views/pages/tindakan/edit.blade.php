                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="harga" name="harga"
                                                        value="{{ $tindakan->getHargaFormattedAttribute() }}" readonly>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select" id="a7" name="status">
                                                        ...
                                                        <option value="1"
                                                            {{ old('status', $tindakan->status) == 1 ? 'selected' : '' }}>
                                                            Aktif</option>
                                                        <option value="2"
                                                            {{ old('status', $tindakan->status) == 2 ? 'selected' : '' }}>
                                                            Tidak Aktif</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control price-input" id="honor_dokter"
                                                        name="honor_dokter"
                                                        value="{{ number_format($tindakan->honor_dokter, 0, ',', '.') }}"
                                                        placeholder="0">
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control price-input"
                                                        ...
                                                        value="{{ number_format($tindakan->bonus_perawat, 0, ',', '.') }}"
                                                        placeholder="0">
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control price-input"
                                                        ...
                                                        value="{{ number_format($tindakan->biaya_bahan, 0, ',', '.') }}"
                                                        placeholder="0">
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control price-input"
                                                        ...
                                                        value="{{ number_format($tindakan->jasa_sarana, 0, ',', '.') }}"
                                                        placeholder="0">
                                                </div>
