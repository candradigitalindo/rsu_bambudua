                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select" id="a2" name="class">
                                                        ...
                                                        <option value="VIP" {{ old('class') == 'VIP' ? 'selected' : '' }}>
                                                            VIP</option>
                                                        <option value="Kelas 1" {{ old('class') == 'Kelas 1' ? 'selected' : '' }}>
                                                            Kelas 1</option>
                                                        <option value="Kelas 2" {{ old('class') == 'Kelas 2' ? 'selected' : '' }}>
                                                            Kelas 2</option>
                                                        <option value="Kelas 3" {{ old('class') == 'Kelas 3' ? 'selected' : '' }}>
                                                            Kelas 3</option>
                                                        <option value="Kelas 4" {{ old('class') == 'Kelas 4' ? 'selected' : '' }}>
                                                            Kelas 4</option>
                                                        <option value="Kelas 5" {{ old('class') == 'Kelas 5' ? 'selected' : '' }}>
                                                            Kelas 5</option>
                                                    </select>
                                                </div>
