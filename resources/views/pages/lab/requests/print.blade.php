                ...
                <td style="width: 50%; vertical-align: top; border: none; padding-right: 20px;">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            {{ $req->encounter->pasien->tanggal_lahir ?? ($req->encounter->tanggal_lahir ? \Carbon\Carbon::parse($req->encounter->tanggal_lahir)->format('d F Y') : '-') }}
                        </div>
                    </div>
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            @php
                                $jenisKelamin =
                                    $req->encounter->pasien->jenis_kelamin ?? ($req->encounter->gender ?? '-');
                                if (
                                    $jenisKelamin == '1' ||
                                    strtolower($jenisKelamin) == 'l' ||
                                    strtolower($jenisKelamin) == 'laki-laki'
                                ) {
                                    echo 'Laki-laki';
                                } elseif (
                                    $jenisKelamin == '2' ||
                                    strtolower($jenisKelamin) == 'p' ||
                                    strtolower($jenisKelamin) == 'perempuan'
                                ) {
                                    echo 'Perempuan';
                                } else {
                                    echo $jenisKelamin;
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-colon">:</div>
                        <div class="info-value">
                            {{ $req->encounter->pasien->alamat ?? ($req->encounter->address ?? '-') }}
                        </div>
                    </div>
                </td>
