@extends('layouts.app')
@section('title','Kalibrasi Alat Medis')
@push('style')
  ...
  <div class="col-12">
    <div class="card mb-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        <div>
          <h5 class="card-title mb-0">Kalibrasi</h5>
      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('inventory.equipment.kalibrasi.store', $equipment->id) }}" class="row g-2 mb-3 align-items-end" enctype="multipart/form-data">
          @csrf
          <div class="col-md-2">
        ...
        <div class="table-responsive">
          <table class="table m-0" id="logTable">
            <thead><tr><th>Tanggal</th><th>Pelaksana</th><th>Catatan</th><th class="text-end">Biaya</th><th>Lampiran</th><th class="text-end">Aksi</th></tr></thead>
            <tbody>
              @forelse($logs as $log)
                <tr>
                  ...
                  <td class="text-end">
                    ...
                    <form action="{{ route('inventory.equipment.maintenance.destroy', $log->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus log kalibrasi?')">
                      @csrf @method('DELETE')
