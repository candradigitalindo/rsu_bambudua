...
@section('content')
    <div class="row gx-3">
        ...
        <div class="col-sm-6 col-12">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('pendidikan.store') }}" method="POST" id="submit">
                        @csrf
                        <!-- Row starts -->
                        <div class="row gx-3">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="a5">Nama Pendidikan <span
                                    ...
                                    @forelse ($pendidikans as $p)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('pendidikan.destroy', $p->id) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Hapus</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
